...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
		...
		allowClear: function(val){
			this.opts.allowClear = val;
			if(!val){
				$(this.container).removeClass("select2-allowclear");
			}
		},
        // abstract
        //select_by_text is for only testing purpose
        //It selects options according to full text textpassed to this function
        select_by_text: function(text){
            $(this.dropdown).find("ul.select2-results li:contains('" + text + "')").addClass("select2-highlighted");
    ...
    $.fn.select2 = function () {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            ...
            allowedMethods = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown", "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "select_by_text", "data", "search", "allowClear"],
